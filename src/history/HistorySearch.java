 ...
 * 
 * @author huangjiaming
 * 订单查询入口：根据用户手机号搜索用户信息
 */
public class HistorySearch extends SlidingFragmentActivity{
	private CanvasTransformer mTransformer;
	private final static String TAG = "HistorySearch";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		phone = (EditText)findViewById(R.id.history_phone);
	...
	final Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			if(msg.what == 0x00){   //车位主
				...
				intent.setClass(HistorySearch.this,SubscribeList.class);
				...
				Intent intent=new Intent();
				intent.setClass(HistorySearch.this,NotFound.class);
				startActivity(intent);
			}
		}
	};
